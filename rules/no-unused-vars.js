...
module.exports = {
  ...
  create(context) {
     ...
     * @private
     */
    function isGoogRequireType(variable) {
      const definition = variable.defs[0];
     ...
     * @return {ASTNode|null} The RHS node or null.
     * @private
     */
     ...
     * @return {boolean} `true` if the variable is defined after the last
     * used parameter.
     */
     ...
     * @return {Variable[]} unused variables of the scope and descendant scopes.
     * @private
     */
